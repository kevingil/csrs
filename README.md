...
A first-person shooter built with Rust and Bevy.
...
> The project uses Bevy's `dynamic_linking` feature for faster dev compile times. For distribution, remove this feature from `Cargo.toml`.
